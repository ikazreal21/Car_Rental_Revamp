...
<head>
    <title> customer Signup | Axl Rentals  </title>
...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Axl Rentals - Registration</h1>
            <br>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="glyphicon glyphicon-phone" aria-hidden="true"></span></label>
                                    </span>
